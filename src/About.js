    ...
    <div>
      <div>
        ...
        <div className="text-justify">
          ...
          <p>Wait Time is currently under development and is the final student project of Maxwell Benton, a graduate of the Flatiron School immersive web development program in New York City</p>

          <p>Maxwell is tired of waiting in lines.</p>
        </div>
